...
struct ASSASSIN_INFO
{
	...
	int J_Bomb_Damage[10];
	int J_Bomb_RangeDamage[10];
	int J_Bomb_UseMana[10];

	int R_Slash_Damage[10];
	int R_Slash_UseMana[10];

	int V_Stab_Damage[10];
	int V_Stab_UseMana[10];

	int Storm_Damage[10];
	int Storm_UseMana[10];
};
...
struct SHAMAN_INFO
{
	...
	int Creed_IncreaseMana[10];
	int Creed_IncreaseStamina[10];
	int Creed_Time[10];
	int Creed_UseMana[10];

	int P_Deity_Damage[10];
	int P_Deity_Range[10];
	int P_Deity_UseMana[10];

	int G_Nail_Damage[10];
	int G_Nail_UseMana[10];

	int H_Regene_IncreaseHP[10];
...
struct MARTIAL_INFO
{
	...
	int D_Mastery2_Damage[10];
	int H_Hawk_Damage[10];
	int H_Hawk_UseMana[10];
	int L_Breaking_Damage[10];
	int L_Breaking_Range[10];
	int L_Breaking_UseMana[10];
	int H_Training_IncreaseForce[10];
	int H_Training_IncreaseAgility[10];
	int H_Training_Time[10];
	int H_Training_UseMana[10];
};
