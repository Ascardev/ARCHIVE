...
void Puzzle::SendRandomItem(rsPLAYINFO* Player)
{
	...
	case JOBCODE_FIGHTER:
		PremioQuest(Player, (sinDB1 | sin35), JOBCODE_FIGHTER); 
		break;
	case JOBCODE_MECHANICIAN:
		PremioQuest(Player, (sinDB1 | sin35), JOBCODE_MECHANICIAN); 
		break;
	case JOBCODE_ARCHER:
		PremioQuest(Player, (sinDB1 | sin35), JOBCODE_ARCHER); 
		break;
	case JOBCODE_PIKEMAN:
		PremioQuest(Player, (sinDB1 | sin35), JOBCODE_PIKEMAN); 
		break;
	case JOBCODE_ATALANTA:
		PremioQuest(Player, (sinDB1 | sin35), JOBCODE_ATALANTA); 
		break;
	case JOBCODE_KNIGHT:
		PremioQuest(Player, (sinDB1 | sin35), JOBCODE_KNIGHT); 
		break;
	case JOBCODE_MAGICIAN:
		PremioQuest(Player, (sinDB1 | sin35), JOBCODE_MAGICIAN); 
		break;
	case JOBCODE_PRIESTESS:
		PremioQuest(Player, (sinDB1 | sin35), JOBCODE_PRIESTESS); 
		break;
	case JOBCODE_ASSASSINE:
		PremioQuest(Player, (sinDB1 | sin35), JOBCODE_ASSASSINE); 
		break;
	case JOBCODE_SHAMAN:
		PremioQuest(Player, (sinDB1 | sin35), JOBCODE_SHAMAN); 
		break;
	case JOBCODE_MARTIAL:
		PremioQuest(Player, (sinDB1 | sin35), JOBCODE_MARTIAL); 
		break;
	}
}
