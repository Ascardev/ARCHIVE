...
void cMixGuide::DrawComboBox()
{
	...
	if (TextureBox1)
	{
		...
		DrawImage(cImages[4], (WinX + 430), (WinY + 40), 110, 26); 
		DrawImage(cImages[5], (WinX + 430), (WinY + 66), 110, 26); 
		DrawImage(cImages[5], (WinX + 430), (WinY + 88), 110, 26); 
		DrawImage(cImages[5], (WinX + 430), (WinY + 112), 110, 26); 
		DrawImage(cImages[5], (WinX + 430), (WinY + 136), 110, 26); 
