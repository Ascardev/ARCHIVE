...
int cITEM::ShowItemInfo(sITEM* pItem, int Flag, int Index)
{
	...
	if (sInfo.CODE == (sinOR1 | sin29) || sInfo.CODE == (sinOA1 | sin26) || sInfo.CODE == (sinOS1 | sin17) || sInfo.CODE == (sinDB1 | sin35)) 
	{
		lstrcpy(szTemp, "Item Boss\r"); 
		lstrcat(szInfoBuff, szTemp);
	...
	if ((sInfo.CODE) == (sinBI1 | sin12)) 
	{

		lstrcpy(szTemp, "Tx de drop 50% adicional\r"); 
		lstrcat(szInfoBuff, szTemp);
		lstrcat(szInfoBuff2, "\r");
		ItemInfoCol++;
	}
	if ((sInfo.CODE) == (sinEC1 | sin03)) 
	{

		lstrcpy(szTemp, "Teleporte para o Abismo\r"); 
		lstrcat(szInfoBuff, szTemp);
		lstrcat(szInfoBuff2, "\r");
		ItemInfoCol++;
	}

	if ((sInfo.CODE) == (sinBI1 | sin14)) 
	{
	...
	if ((sInfo.CODE) == (sinBI1 | sin24)) 
	{

		lstrcpy(szTemp, "Exp. 50% adicional\r"); 
		lstrcat(szInfoBuff, szTemp);
		lstrcat(szInfoBuff2, "\r");
		ItemInfoCol++;
	}
	if ((sInfo.CODE) == (sinBI1 | sin25)) 
	{
	...
	if ((sInfo.CODE) == (sinBI1 | sin20)) 
	{

		lstrcpy(szTemp, "Converte o dano em HP\r"); 
		lstrcat(szInfoBuff, szTemp);
		lstrcat(szInfoBuff2, "\r");
		ItemInfoCol++;
	}
	if ((sInfo.CODE) == (sinBI1 | sin22)) 
	{

		lstrcpy(szTemp, "Converte o dano em MP\r"); 
		lstrcat(szInfoBuff, szTemp);
		lstrcat(szInfoBuff2, "\r");
		ItemInfoCol++;
	}
	if ((sInfo.CODE) == (sinBI1 | sin52)) 
	{

		lstrcpy(szTemp, "5% de ATQ adicional\r"); 
		lstrcat(szInfoBuff, szTemp);
		lstrcat(szInfoBuff2, "\r");
		ItemInfoCol++;
	}
	if ((sInfo.CODE) == (sinBI1 | sin53)) 
	{
	...
	if ((sInfo.CODE) == (sinBI1 | sin89)) 
	{

		lstrcpy(szTemp, "Remove o mix ou aging de um item\nstatus e spec são mantidos\r"); 
		lstrcat(szInfoBuff, szTemp);
		lstrcat(szInfoBuff2, "\r");
		ItemInfoCol++;
		ItemInfoCol++;
	}
	if ((sInfo.CODE) == (sinBI1 | sin85)) 
	{
	...
	if ((sInfo.CODE) == (sinBI2 | sin46)) 
	{
		lstrcpy(szTemp, "Combine com 2 Super Jeras\n(Garante status perfeito)\r"); 
		lstrcat(szInfoBuff, szTemp);
		lstrcat(szInfoBuff2, "\r");
		ItemInfoCol++;
		ItemInfoCol++;
	}
	if ((sInfo.CODE) == (sinBI2 | sin47)) 
	{
		lstrcpy(szTemp, "Combine com 2 Super Jeras\n(Garante status perfeito)\r"); 
		lstrcat(szInfoBuff, szTemp);
		lstrcat(szInfoBuff2, "\r");
	...
	if ((sInfo.CODE) == (sinEC1 | sin03)) 
	{
		lstrcpy(szTemp, "Teleporte Boss Espectro de Ossos\r"); 
		lstrcat(szInfoBuff, szTemp);
		lstrcat(szInfoBuff2, "\r");
	...
	if (sInfo.CODE == (sinBI2 | sin38) || sInfo.CODE == (sinBI2 | sin39) || sInfo.CODE == (sinBI2 | sin40) || sInfo.CODE == (sinBI2 | sin41)
		|| sInfo.CODE == (sinBI2 | sin42) || sInfo.CODE == (sinBI2 | sin43) || sInfo.CODE == (sinBI2 | sin44)) 
	{
	...
	if (sInfo.CODE == (sinEV1 | sin01) || sInfo.CODE == (sinEV1 | sin02) || sInfo.CODE == (sinEV1 | sin03) || sInfo.CODE == (sinEV1 | sin04)
		|| sInfo.CODE == (sinEV1 | sin05) || sInfo.CODE == (sinEV1 | sin06) || sInfo.CODE == (sinEV1 | sin07)) 
	{
	...
	if ((sInfo.CODE) == (sinEV2 | sin01) || (sInfo.CODE) == (sinEV2 | sin02)) 
	{
