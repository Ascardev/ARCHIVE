...
void Quest::Updater(EQuestID Quest)
{
	...
	case QUESTID_AMULETO:
		...
		if (QuestAmuleto_State == 1 && QuestAmuleto_Param1 == 300 && QuestAmuleto_Param2 == 250 )
		{
				...
				if (SQL::GetInstance()->Fetch())
				{
					...
					if (State == 1 && Param1 == 100 && Param2 == 150)
					{
						...
						case JOBCODE_FIGHTER:
							PremioQuest(Player, (sinDB1 | sin32), JOBCODE_FIGHTER); 
							break;
						case JOBCODE_MECHANICIAN:
							PremioQuest(Player, (sinDB1 | sin32), JOBCODE_MECHANICIAN); 
							break;
						case JOBCODE_ARCHER:
							PremioQuest(Player, (sinDB1 | sin32), JOBCODE_ARCHER); 
							break;
						case JOBCODE_PIKEMAN:
							PremioQuest(Player, (sinDB1 | sin32), JOBCODE_PIKEMAN); 
							break;
						case JOBCODE_ATALANTA:
							PremioQuest(Player, (sinDB1 | sin32), JOBCODE_ATALANTA); 
							break;
						case JOBCODE_KNIGHT:
							PremioQuest(Player, (sinDB1 | sin32), JOBCODE_KNIGHT); 
							break;
						case JOBCODE_MAGICIAN:
							PremioQuest(Player, (sinDB1 | sin32), JOBCODE_MAGICIAN); 
							break;
						case JOBCODE_PRIESTESS:
							PremioQuest(Player, (sinDB1 | sin32), JOBCODE_PRIESTESS); 
							break;
						case JOBCODE_ASSASSINE:
							PremioQuest(Player, (sinDB1 | sin32), JOBCODE_ASSASSINE); 
							break;
						case JOBCODE_SHAMAN:
							PremioQuest(Player, (sinDB1 | sin32), JOBCODE_SHAMAN); 
							break;
						case JOBCODE_MARTIAL:
							PremioQuest(Player, (sinDB1 | sin32), JOBCODE_MARTIAL); 
							break;
						}
						LOGEx(Player, "Quest", "%s completed QuestCode:%d", Player->szName, packet->WParam);
					}
		...
		if (SQL::GetInstance()->IsConnected())
		{
			...
			if (SQL::GetInstance()->Execute(szQuery))
			{
				if (SQL::GetInstance()->Fetch())
				{
					...
					if (State == 1 && Param1 == 300 && Param2 == 250)
					{
						wsprintf(szQuery, "UPDATE [PristonDB].[dbo].[Quest] SET State=2 WHERE [Character]='%s' AND [Code]=%d", Player->szName, packet->WParam);
						SQL::GetInstance()->Execute(szQuery);
						...
						{
						case JOBCODE_FIGHTER:
							PremioQuest(Player, (sinOA1 | sin29), JOBCODE_FIGHTER); 
							break;
						case JOBCODE_MECHANICIAN:
							PremioQuest(Player, (sinOA1 | sin29), JOBCODE_MECHANICIAN); 
							break;
						case JOBCODE_ARCHER:
							PremioQuest(Player, (sinOA1 | sin29), JOBCODE_ARCHER); 
							break;
						case JOBCODE_PIKEMAN:
							PremioQuest(Player, (sinOA1 | sin29), JOBCODE_PIKEMAN); 
							break;
						case JOBCODE_ATALANTA:
							PremioQuest(Player, (sinOA1 | sin29), JOBCODE_ATALANTA); 
							break;
						case JOBCODE_KNIGHT:
							PremioQuest(Player, (sinOA1 | sin29), JOBCODE_KNIGHT); 
							break;
						case JOBCODE_MAGICIAN:
							PremioQuest(Player, (sinOA1 | sin29), JOBCODE_MAGICIAN); 
							break;
						case JOBCODE_PRIESTESS:
							PremioQuest(Player, (sinOA1 | sin29), JOBCODE_PRIESTESS); 
							break;
						case JOBCODE_ASSASSINE:
							PremioQuest(Player, (sinOA1 | sin29), JOBCODE_ASSASSINE); 
							break;
						case JOBCODE_SHAMAN:
							PremioQuest(Player, (sinOA1 | sin29), JOBCODE_SHAMAN); 
							break;
						case JOBCODE_MARTIAL:
							PremioQuest(Player, (sinOA1 | sin29), JOBCODE_MARTIAL); 
							break;
						}
						LOGEx(Player, "Quest", "%s completed QuestCode:%d", Player->szName, packet->WParam);
					}
			...
			if (SQL::GetInstance()->Execute(szQuery))
			{
				if (SQL::GetInstance()->Fetch())
				{
					...
					if (State == 1 && Param1 == 100 && Param2 == 70)
					{
						...
						{
						case JOBCODE_FIGHTER:
							rsPutItem(Player, sinCA5 | sin10); 
							break;
						case JOBCODE_MECHANICIAN:
							rsPutItem(Player, sinCA5 | sin10); 
							break;
						case JOBCODE_ARCHER:
							rsPutItem(Player, sinCA5 | sin12); 
							break;
						case JOBCODE_PIKEMAN:
							rsPutItem(Player, sinCA5 | sin10); 
							break;
						...
						case JOBCODE_KNIGHT:
							...
							break;
						case JOBCODE_MAGICIAN:
							rsPutItem(Player, sinCA6 | sin10); 
							break;
						case JOBCODE_PRIESTESS:
							rsPutItem(Player, sinCA6 | sin12); 
							break;
						case JOBCODE_ASSASSINE:
							rsPutItem(Player, sinCA5 | sin12); 
							break;
...
void Quest::OpenNPC(DWORD Code)
{
	...
	case QUESTID_AMULETO:
		...
		case 0:
			...
			break;
		case 1:
			if (QuestAmuleto_Param1 < 300 || QuestAmuleto_Param2 < 250 )
